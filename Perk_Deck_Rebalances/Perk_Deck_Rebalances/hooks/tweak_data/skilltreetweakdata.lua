Hooks:PostHook(SkillTreeTweakData, "init", "PDR SkillTreeTweakData itit", function(self)
	...
	table.insert(self.specializations[14][3].upgrades, "player_cocaine_stack_absorption_multiplier_1")
	...
	table.insert(self.specializations[14][5].upgrades, "player_cocaine_stacks_interaction_speed")
	table.remove(self.specializations[14][9].upgrades, 2)
	table.insert(self.specializations[14][9].upgrades, "player_cocaine_stacks_damage_reduction")
